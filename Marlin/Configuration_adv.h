...
#define EXTRUDER_AUTO_FAN_SPEED 100     // 255 == full speed // 12V on 24V psu - half pwm
...
#define HOMING_BUMP_MM      { 5, 5, 6 }       // (mm) Backoff from endstops after first bump
...
#if EITHER(IS_ULTIPANEL, EXTENSIBLE_UI, NEXTION_DISPLAY)
  #define MANUAL_FEEDRATE { 50*60, 50*60, 4*60, 2*60 } // (mm/min) Feedrates for manual moves along X, Y, Z, E from panel
  #define FINE_MANUAL_MOVE 0.04    // (mm) Smallest manual move (< 0.1mm) applying to Z on most machines
  #if IS_ULTIPANEL
 ...
 */
  ...
  #define G29_RETRY_AND_RECOVER
     ...
     */
    #define G29_SUCCESS_COMMANDS "M117 Poziomowanie zakonczone pomyslnie."
    #define G29_RECOVER_COMMANDS "M117 Sondowanie nieudane. Rewiping.\nG28\nG12 P0 S12 T0"
    #define G29_FAILURE_COMMANDS "M117 Poziomowanie nieudane.\nG0 Z10\nM300 P25 S880\nM300 P50 S0\nM300 P25 S880\nM300 P50 S0\nM300 P25 S880\nM300 P50 S0\nG4 S1"
