...
#define BABYSTEPPING
  ...
  #define BABYSTEP_MULTIPLICATOR_Z  128       // (steps or mm) Steps or millimeter distance for each Z babystep
  #define BABYSTEP_MULTIPLICATOR_XY 128       // (steps or mm) Steps or millimeter distance for each XY babystep
