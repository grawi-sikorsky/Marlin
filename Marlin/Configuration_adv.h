...
#define EXTRUDER_AUTO_FAN_SPEED 128   // 255 == full speed // 12V on 24V psu - half pwm
...
#if ENABLED (ULTIPANEL) || ENABLED (EXTENSIBLE_UI) || ENABLED(NEXTION_DISPLAY)
...
#define BABYSTEPPING
  ...
  #define BABYSTEP_MULTIPLICATOR_Z  32       // (steps or mm) Steps or millimeter distance for each Z babystep
  #define BABYSTEP_MULTIPLICATOR_XY 32       // (steps or mm) Steps or millimeter distance for each XY babystep
