...
#if ANY(HAS_DGUS_LCD, MALYAN_LCD, TOUCH_UI_FTDI_EVE, ANYCUBIC_LCD_I3MEGA, ANYCUBIC_LCD_CHIRON, NEXTION_TFT, NEXTION_DISPLAY)
  #define IS_EXTUI 1
...
#if IS_ULTRA_LCD || ENABLED(NEXTION_DISPLAY)
...
#if IS_ULTIPANEL && DISABLED(NO_LCD_MENUS) || ENABLED(NEXTION_DISPLAY)
...
#endif
#if !HAS_LEVELING || EITHER(MESH_BED_LEVELING, AUTO_BED_LEVELING_UBL) && DISABLED(NEXTION_DISPLAY)
