...
#define HAS_DISPLAY         (HAS_SPI_LCD || ENABLED(EXTENSIBLE_UI)) //nextion ENABLED(NEXTION) || 
#define HAS_GRAPHICAL_LCD    ENABLED(DOGLCD) 
#define HAS_CHARACTER_LCD   (HAS_SPI_LCD && !HAS_GRAPHICAL_LCD)
#define HAS_LCD_MENU        (ENABLED(ULTIPANEL) && DISABLED(NO_LCD_MENUS)) //nextion ENABLED(NEXTION) ||
...
#define HAS_RESUME_CONTINUE          ANY(EXTENSIBLE_UI, NEWPANEL, EMERGENCY_PARSER, NEXTION_DISPLAY) // nextion
