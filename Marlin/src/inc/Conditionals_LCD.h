...
#if ANY(HAS_DGUS_LCD, MALYAN_LCD, TOUCH_UI_FTDI_EVE, ANYCUBIC_LCD_I3MEGA, ANYCUBIC_LCD_CHIRON, NEXTION_DISPLAY)
  #define IS_EXTUI
...
#if ENABLED(ULTIPANEL) && DISABLED(NO_LCD_MENUS) || ENABLED(NEXTION_DISPLAY)
