...
namespace Language_pl {
  ...
  PROGMEM Language_Str MSG_ERR_MAXTEMP                     = _UxGT("Blad: E MAXTEMP");
  PROGMEM Language_Str MSG_ERR_MINTEMP                     = _UxGT("Blad: E MINTEMP");
  PROGMEM Language_Str MSG_ERR_MAXTEMP_BED                 = _UxGT("Blad: MAXTEMP BED");
  PROGMEM Language_Str MSG_ERR_MINTEMP_BED                 = _UxGT("Blad: MINTEMP BED");
  ...
  PROGMEM Language_Str MSG_FILAMENT_CHANGE_OPTION_PURGE    = _UxGT("Ekstruduj wiecej");
