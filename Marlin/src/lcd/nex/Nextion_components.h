...
#define MSG_SPLASH_1		_UxGT("Let's print!")
#define MSG_SPLASH_2		_UxGT("Did you print something today?")
#define MSG_SPLASH_3		_UxGT("Clean your 3D printer, it has feelings too..")
#define MSG_SPLASH_4		_UxGT("Don't try this.. I know you want to..")
#define MSG_SPLASH_5		_UxGT("How are you?")
#define MSG_SPLASH_6		_UxGT("Good day!")
#define MSG_SPLASH_7		_UxGT("Dont print waste.. It's waste.")
#define MSG_SPLASH_8		_UxGT("Be hero in your home, print some spare parts!")
#define MSG_SPLASH_9		_UxGT("Good filament is 50% of succesfull print.")
#define MSG_SPLASH_10		_UxGT("Yeah, cupholder is a good idea..")
#define MSG_SPLASH_11		_UxGT("If you didnt print today, i'll tell my dad.")
#define MSG_SPLASH_12		_UxGT("It's not my fault.. :<")
#define MSG_SPLASH_13		_UxGT("Hey! You created gcode, not me!")
#define MSG_SPLASH_14		_UxGT("Uaaaaaghh... Did I sleep?")
#define MSG_SPLASH_15		_UxGT("YOU'RE BACK!")
#define MSG_SPLASH_16		_UxGT("Dont push me, I print at my own pace.")
#define MSG_SPLASH_17		_UxGT("Why are you waking me up?")
#define MSG_SPLASH_18		_UxGT("Nope.")
#define MSG_SPLASH_19		_UxGT("Seriously.. Do i have to?")
#define MSG_SPLASH_20		_UxGT("I'm  watching you..")
#define MSG_SPLASH_21		_UxGT("Stroke my belts and gears.. mrrrrr..")
#define MSG_SPLASH_22		_UxGT("Stroke my belts and gears.. mrrrrr..")
#define STARTPAGE				"start"