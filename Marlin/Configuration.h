...
// This will remove the need to poll the interrupt pins, saving many CPU cycles. ciekawe
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 400, 400, 50, 90 }
 ...
 */
  ...
  #define JUNCTION_DEVIATION_MM 0.08 // 0.012(mm) Distance from real junction edge
#endif
...
#define NOZZLE_PARK_FEATURE
  ...
  #define NOZZLE_PARK_POINT { (X_MAX_POS - 20), (Y_MAX_POS - 20), 15 }
